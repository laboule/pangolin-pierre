...
$(function () {
  ...
  var updateDomWithNewDream = function updateDomWithNewDream(dream) {
    var user_name = dream.user_name,
        dream_is_nsfw = dream.dream_is_nsfw,
        user_city = dream.user_city,
        dream_date = dream.dream_date,
        url = dream.url;
    var date = new Date(dream_date);
    var options = {
      year: "numeric",
      month: "long"
    };
  ...
  var fetchDream = /*#__PURE__*/function () {
    ...
    return function fetchDream() {
      return _ref.apply(this, arguments);
    };
  }();

  var showButton = function showButton() {
    var button = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "play";
  ...
  $("#continue-listen, #close-listen-modal").click(function () {
    $(".listen-modal").hide(); // autoplay audio
  ...
  var currentStep = $(".record-container").data("step");
  ...
  $(".record-container .record").click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5() {
  ...
  $(".record-container .stop").click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6() {
  ...
  var onEncoderLoaded = function onEncoderLoaded(recorder, encoding) {
            ...
            case 5:
              ...
              recorder = new WebAudioRecorder(input, {
                ...
                onEncoderLoading: function onEncoderLoading(recorder, encoding) {
                  return __log("Loading " + encoding + " encoder...");
                },
                onEncoderLoaded: onEncoderLoaded,
  ...
  function createAudioElementFromBlob(blob, encoding) {
    ...
    $("#audio-record").attr("src", url); // Adds binary data to form input
...
__webpack_require__(/*! C:\wamp64\www\pangolin\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\pangolin\resources\sass\app.scss */"./resources/sass/app.scss");
