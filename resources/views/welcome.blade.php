@extends('layouts.app')
@section('content')
<div class="listen-container" data-dream="{{$dream ?? ''}}" data-autoplay="{{$autoplay}}" data-showplayer="{{$show_player}}" data-minlistens="{{env('MIN_LISTENS', 5)}}" data-minlistens="{{env('MAX_LISTENS', 10)}}">
